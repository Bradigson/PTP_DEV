...
namespace BussinessLayer.Services
{
    public class ProductoService : IProductoService
    {
        ...
        public async Task<List<ProductoInfoViewModel>> GetInfoViewModelList(long idEMpresa) =>
            ProductoToInfoViewModel(await GetAll(idEMpresa),idEMpresa);
        public async Task<List<ProductoInfoViewModel>> GetInfoViewModelListAgotado(long idEMpresa) =>
           ProductoToInfoViewModel(await GetAllAgotados(idEMpresa), idEMpresa);
        ...
        public async Task<bool> CheckCodeExist(string productCode)
        {
            ...
            {
                return await context.Productos.AnyAsync(x => x.Codigo.Equals(productCode));
            }
        }
        ...
        {
            return ProductoToInfoViewModel(await GetAll(idEMpresa),idEMpresa);
        ...
        public async Task Edit(Producto entity)
        {
            using (var context = new PDbContext())
            {
                try
                {
                    var oldVersion = await context.Productos.FindAsync(entity.Id);
        ...
        public async Task Delete(int id, long idEMpresa)
        {
            using (var context = new PDbContext())
            {
                var producto = await context.Productos.Where(x=>x.IdEmpresa==idEMpresa && x.Id==id).FirstOrDefaultAsync();
        ...
        private List<ProductoInfoViewModel> ProductoToInfoViewModel(IList<Producto> productos, long idEMpresa)
        {
        ...
        public async Task<Producto> GetByIdDesc(int id, long idEMpresa)
        {
            using (var context = new PDbContext())
            {
               return await context.Productos
