...
namespace BussinessLayer.Services
{
    public class DgiiNcfService : IDgiiNcfService
    {
        ...
        public DgiiNcfService()
        {
            _context = new PDbContext();
        }
        public async Task Add(DgiiNcf entity)
        {
            try
            {
        ...
        public async Task Edit(DgiiNcf entity)
        {
            try
            {
        ...
        public async Task<DgiiNcf> GetById(int id, long idEMpresa)
        {
            return await _context.DgiiNcf.FindAsync(id);
        }

        public async Task<IList<DgiiNcf>> GetAll(long idEMpresa)
        {
